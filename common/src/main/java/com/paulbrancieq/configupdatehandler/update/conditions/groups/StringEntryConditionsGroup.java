...
public class StringEntryConditionsGroup extends BasicRootEntryConditionsGroup {
    protected static ConditionsGroupDef def = new ConditionsGroupDef(BasicRootEntryConditionsGroup.def) {
        {
            // Expected type
            set (Constants.CUH.UpdateFile.ConditionsFields.Name.EXPECTED_ENTRY_TYPE, new StringOptionValueUniqueDef(Constants.CUH.UpdateFile.ConditionsFields.PossibleValues.STRING_ENTRY_TYPE));
        }
    };

    public StringEntryConditionsGroup(Map<String, Object> conditions) throws InvalidUpdateOptionGroup {
